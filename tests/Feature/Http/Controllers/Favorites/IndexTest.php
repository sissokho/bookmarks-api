...
class IndexTest extends TestCase
{
    ...
    /** @test */
    public function favorite_bookmarks_are_listed_by_the_most_recent_in_a_paginated_way(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJson([
                'links' => [
                    'first' => route('api.v1.favorites.index', ['page' => 1]),
                    'last' => route('api.v1.favorites.index', ['page' => 2]),
                    'prev' => null,
                    'next' => route('api.v1.favorites.index', ['page' => 2]),
                ],
                'meta' => [
                    'current_page' => 1,
                    'from' => 1,
    ...
    /** @test */
    public function only_users_favorite_bookmarks_are_shown(): void
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function only_favorite_bookmarks_are_returned(): void
    {
        $user = User::factory()->create();
    ...
    public function user_can_customize_the_pagination(): void
    {
        ...
        $response = $this->getJson(route('api.v1.favorites.index', ['per_page' => 10, 'page' => 2]));
        ...
        $response->assertOk()
            ...
            ->assertJson([
                'links' => [
                    'first' => route('api.v1.favorites.index', ['page' => 1]),
                    'last' => route('api.v1.favorites.index', ['page' => 2]),
                    'prev' => route('api.v1.favorites.index', ['page' => 1]),
                    'next' => null,
                ],
                'meta' => [
                    'current_page' => 2,
    ...
    /** @test */
    public function user_can_search_through_his_favorite_bookmarks(): void
    {
        $user = User::factory()->create();
        ...
        $response = $this->getJson(route('api.v1.favorites.index', ['search' => 'down']));
     ...
     */
    public function user_can_customize_the_ordering_of_his_favorite_bookmarks(Order $order): void
    {
        $user = User::factory()->create();
        ...
        $response = $this->getJson(route('api.v1.favorites.index', ['order_by' => $order->value]));
    ...
    public function parameters_are_validated($params, $errors): void
    {
        ...
        $response = $this->getJson(route('api.v1.favorites.index', $params));
